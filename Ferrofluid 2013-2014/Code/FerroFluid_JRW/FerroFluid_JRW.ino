...
float pot;
float totalTime = 9.0;
float lastLapTime = 1.01;
float currentSpeed = 88.88;
float avgSpeed = 15.02;
float totalDist = 6.03;
...
void draw(void) {
  ...
  u8g.drawStr(8,9,"Duty Cycle");  
  u8g.setFont(u8g_font_fur17);
  u8g.setPrintPos(8,29);
  u8g.print(duty_cycle);
  //Mode/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  u8g.setFont(u8g_font_profont10);
  u8g.drawStr(8,40,"Mode");  
  u8g.setFont(u8g_font_fur17);
  u8g.setPrintPos(8,60);
  u8g.print(mode);
  //Coil Temp/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  u8g.setFont(u8g_font_profont10);
  u8g.drawStr(174,9,"Coil Temp F");  
  u8g.setFont(u8g_font_fur17);
  u8g.setPrintPos(174,29);
  u8g.print(tempFar);
  //Distance//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  u8g.setFont(u8g_font_profont10);
  u8g.drawStr(174,40,"Distance");  
  u8g.setFont(u8g_font_fur17);
  u8g.setPrintPos(174,60);
  u8g.print(totalDist);
